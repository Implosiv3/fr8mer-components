export default function TwitchLogoSVG() {
    return (

        <svg stroke="currentColor" fill="rgba(15, 15, 18, 0.5)" stroke-width="0" role="img" viewBox="0 0 24 24" height="13" width="13" xmlns="http://www.w3.org/2000/svg">
